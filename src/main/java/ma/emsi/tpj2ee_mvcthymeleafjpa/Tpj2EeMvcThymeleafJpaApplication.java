...
public class Tpj2EeMvcThymeleafJpaApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        patientRepository.save(new Patient(null,"Sadik",new Date(),false,96));
        patientRepository.save(new Patient(null,"reda",new Date(),false,58));
        patientRepository.save(new Patient(null,"Oussama",new Date(),false,58));
        patientRepository.save(new Patient(null,"fati",new Date(),false,99));
